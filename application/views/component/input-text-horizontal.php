<div class="form-group">
    ...
    <div class="col-md-9">
        <input type="text" required="" name="<?php echo $name?>" id="<?php echo $name?>" class="form-control"
            value="<?php echo ($this->session->flashdata('post') ? (isset($this->session->flashdata('post')[$name]) ? $this->session->flashdata('post')[$name] : '') : (isset($default) ? $default : '')) ?>" 
